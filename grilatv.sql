...
--
-- Host: 127.0.0.1:3308
-- Generation Time: Feb 09, 2020 at 12:38 PM
...
--
  ...
  --
INSERT INTO `abonamente` (`ID`, `Client`, `Oferta`)
VALUES
  (1, 30513, 4),
  (2, 13951, 1),
  (3, 82694, 5),
...
CREATE TABLE IF NOT EXISTS `abonati` (
  ...
  ) ENGINE = InnoDB AUTO_INCREMENT = 99215 DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci;
--
  -- Dumping data for table `abonati`
  --
INSERT INTO `abonati` (`Cod_Client`, `Email`)
VALUES
...
--
  ...
  --
INSERT INTO `difuzari` (`ID`, `Emisiune`, `Post`, `Program`)
VALUES
  (1, 1, 1, 5),
  (2, 1, 5, 2),
  (3, 2, 3, 3),
...
--
  ...
  --
INSERT INTO `emisiuni` (`ID`, `Denumire`, `Descriere`, `Tip`)
VALUES
  ...
  (
    42,
    'Herry Potter si Pocalul de Foc',
    '',
    'aventura'
  ),
...
VALUES
  (1, 'Filme', NULL, 'Film', 24.3, 4),
  (2, 'Documentar', NULL, 'Documentare', 38.26, 8),
  ...
  (11, 'Filme', NULL, 'Film', 24.3, 5),
  (12, 'Filme', NULL, 'Film', 24.3, 6),
  (13, 'Filme', NULL, 'Film', 24.3, 7),
  (14, 'Documentar', NULL, 'Documentare', 38.26, 9),
  (15, 'Documentar', NULL, 'Documentare', 38.26, 10);
-- --------------------------------------------------------
  --
...
VALUES
  ...
  (
    'marilena87@yahoo.com',
    'Paraschiv',
    'Tiberiu',
    'Tecuci',
    'Galati',
    'P-ata Albert Einstein',
    '3',
    '',
    '',
    0,
  ...
  (
    'mircea.stanescu@tataru.org',
    'Tudorache',
    'Gina',
    'Hunedoara',
    'Hunedoara',
    'Aleea Mihai Eminescu',
    '8A',
    '',
    '',
    0,
  ...
  (
    'paulina.albu@mihai.biz',
    'Pirvu',
    'Razvan',
    'Turceni',
    'Hunedoara',
    'Splaiul Albert Einstein',
    '608',
    '',
    '',
    0,
...
--
  ...
  --
INSERT INTO `posturitv` (`Numar`, `Denumire`, `Generic`, `PachetTV`)
VALUES
  (1, 'TVR 1', 'Generic', 1),
  (2, 'Pro TV', 'Generic', 1),
...
ADD
  CONSTRAINT `abonamente_ibfk_1` FOREIGN KEY (`Client`) REFERENCES `abonati` (`Cod_Client`),
ADD
  CONSTRAINT `abonamente_ibfk_2` FOREIGN KEY (`Oferta`) REFERENCES `oferte` (`ID`);
--
  -- Constraints for table `abonati`
  --
ALTER TABLE `abonati`
ADD
  CONSTRAINT `abonati_ibfk_1` FOREIGN KEY (`Email`) REFERENCES `persoane` (`Email`);
--
  -- Constraints for table `difuzari`
  --
ALTER TABLE `difuzari`
ADD
  CONSTRAINT `difuzari_ibfk_1` FOREIGN KEY (`Emisiune`) REFERENCES `emisiuni` (`ID`),
ADD
  CONSTRAINT `difuzari_ibfk_2` FOREIGN KEY (`Post`) REFERENCES `posturitv` (`Numar`),
ADD
  CONSTRAINT `difuzari_ibfk_3` FOREIGN KEY (`Program`) REFERENCES `programe` (`ID`);
--
  -- Constraints for table `oferte`
  --
ALTER TABLE `oferte`
ADD
  CONSTRAINT `oferte_ibfk_1` FOREIGN KEY (`Pachet`) REFERENCES `pachetetv` (`ID`);
--
  -- Constraints for table `pachetetv`
  --
ALTER TABLE `pachetetv`
ADD
  CONSTRAINT `pachetetv_ibfk_1` FOREIGN KEY (`Asemanare`) REFERENCES `pachetetv` (`ID`);
--
  -- Constraints for table `posturitv`
  --
ALTER TABLE `posturitv`
ADD
  CONSTRAINT `posturitv_ibfk_1` FOREIGN KEY (`PachetTV`) REFERENCES `pachetetv` (`ID`);
COMMIT;
